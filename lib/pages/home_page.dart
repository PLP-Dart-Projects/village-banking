        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(top: 50,bottom: 10,left: 25,right: 8),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(top: 20,bottom: 10,left: 25,right: 8),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const SizedBox(
                      width: 140,
                      child: Text('Check your Groups',
                        style: TextStyle(
                          fontSize: 20,
                          color: Color.fromRGBO(255, 255, 255, 1),
                        ),
